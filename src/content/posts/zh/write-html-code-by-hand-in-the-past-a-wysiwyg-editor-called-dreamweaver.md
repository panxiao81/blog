...
description: "这一套文章的内容可以说几乎没有学习价值，现在的前端开发已经大大的和以前不同了。 但如果你只是单纯的感兴趣，或因为某种原因需要学这些过去的手写 HTML 的方法的话，则我不会阻拦你继续看下去。 在一切的开始之前，我们要首先来看导致我开了这个坑的万恶之源，Adobe Dreamweaver。"
draft: true
