...
date: 2020-02-20
description: "压缩器（Compressor）或动态范围压缩（Dynamic range compression）是混音中的好伙伴。你通常会在绝大多数轨道上都见到他的身影。本文是压缩器的第一章节，会介绍压缩器的基础，同时给出基本的例子来实际体会压缩器的用途。"
draft: false
...
![Avid Dyn3 Compressor/Limiter](./mixing-basics-mixing-basicscompressorcheaper-1/images/mixing/Compresor/cheaper1/AvidDyn3CompressorLimiter.png)
